...
(1, 'Jean Dupont', 'jean.dupont@gmail.com', 'Bonjour, quels sont vos horaires d’ouverture ?'),
(3, 'Marie Lefèvre', 'marie.lefevre@hotmail.com', 'Faites-vous des commandes en ligne ?'),
(6, 'Luc Martin', 'luc.martin@yahoo.fr', 'Pouvez-vous intervenir sur Sallanches ?');
